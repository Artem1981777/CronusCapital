...
- **Live demo:** https://cronus-capital.vercel.app
- **Verify in 2 min (no keys):** run **npm run verify-live** (145 checks) or open **/api/scorecard**
...
- **No-key end-to-end:** `npm run verify-live` (145 checks) and `npm run verify-intent` (EIP-712 round-trip) reproduce the entire honesty surface against the live deployment without any secret.
...
- One-command replay — **npm run verify-live** (145 checks)
