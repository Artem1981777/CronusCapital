// lib/provenance/routes.js - wrappers around the stubs in lib/upgrades/. ADDITIVE.
// Not one file in lib/upgrades/ is modified: the handlers are called as they are
// and their response is honestly labeled with the provenance of its data.
//   synthetic   is about the INPUT DATA (hard-coded, or obtained at runtime)
//   computation is about the MATH (a real formula, or a descriptive stub)
