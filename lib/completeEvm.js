...
const ARC_DOMAIN = Number(process.env.ARC_MAINNET_CCTP_DOMAIN || "26")
const MESSAGE_TRANSMITTER = process.env.CCTP_MAINNET_MESSAGE_TRANSMITTER || "0x81D40F21F12A8F0E3252Bccb954D722d4c464B64"
...
export default async function handler(req, res) {
  ...
  if (!dest) { res.status(400).json({ status: "unsupported_destination", detail: "destinationDomain " + attDom + " has no EVM completer target (pass ?dest=base to override)", destinationDomain: attDom }); return }
