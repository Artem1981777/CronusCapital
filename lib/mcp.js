...
async function callTool(base, name, args, clientName) {
  ...
  const READONLY = { cronus_receipts: "/api/receipts", cronus_metrics: "/api/metrics", cronus_leaderboard: "/api/leaderboard", cronus_balance: "/api/balance", cronus_payout_status: "/api/payout-status" }
  if (READONLY[name]) {
