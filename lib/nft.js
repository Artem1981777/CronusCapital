...
const CERT = (process.env.DRILL_CERTIFICATE || "0x8B5A4aff399e37F5d571A13aABbD095Bb91D0fB5").toLowerCase()
const PASS = (process.env.ACCESS_PASS || "0x668811DD7e0b1c9DaBb041BE4a9d064789a77E05").toLowerCase()
...
const PUBLISHED = [
  ...
  { label: "Agent guard v2", address: "0x37846B767EC1889b0b719945c1168e42228b944C" },
  ...
  { label: "Identity registry (ERC-8004)", address: "0x5B179bFF284a17a5C8C3ccaDed1984949B410522" },
  { label: "Reputation", address: "0x7426bF7ec186F7E0fb57D3f9487fA94234D2C1Dd" },
  { label: "Job escrow", address: "0x5C7f8f12D6aEcbA1A7461435F45f25b6c8Be18Ad" },
  { label: "Vault", address: "0x6104FC25E1B32B69F5c3Ef0DbBE4D7eC2821b0d3" },
...
const KNOWN_UNVERIFIABLE = {
  "0x37846b767ec1889b0b719945c1168e42228b944c":
    "deployed from a 0.8.36 build. This explorer lists 0.8.36, accepts the submission and then never finishes it - we tried standard-input, flattened-code and multi-part. Proven, not guessed: the identical source compiled with 0.8.35 and deployed as a throwaway canary at 0xD8A26144Ff1838bB6fecd467418Db979985f0346 verified within a minute. Closing this needs a redeploy on 0.8.35 plus a role migration through the 48h timelock, so it is scheduled rather than hidden.",
