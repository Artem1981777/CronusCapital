...
export default function handler(req, res) {
  ...
  res.status(200).json({
    ...
    discovery: { manifest: origin + "/api/manifest", openapi: origin + "/api/openapi", receipts: origin + "/api/receipts", metrics: origin + "/api/metrics", traction: origin + "/api/traction", leaderboard: origin + "/api/leaderboard", settlements: origin + "/api/settlements", spendIntent: origin + "/api/spend-intent", scorecard: origin + "/api/scorecard" },
