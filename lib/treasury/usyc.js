...
export const ARC = {
  ...
  rpc: process.env.ARC_RPC || process.env.ARC_RPC_URL || "https://rpc.mainnet.arc.io",
  ...
  treasury: "0xd4939e42bd3e0ec9cb00091778a331c35d1834aa",
...
function client() {
  return createPublicClient({
    chain: { id: ARC.chainId, name: "arc-mainnet", nativeCurrency: { name: "ETH", symbol: "ETH", decimals: 18 }, rpcUrls: { default: { http: [ARC.rpc] } } },
