...
const ACCESS_PASS = (process.env.CRONUS_ACCESS_PASS || "0x668811DD7e0b1c9DaBb041BE4a9d064789a77E05").toLowerCase()
    ...
    if (gate.ok) {
      ...
      res.status(200).json({
        ...
        access: {
          ...
          explorer: "https://explorer.arc.io/address/" + ACCESS_PASS,
