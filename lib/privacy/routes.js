// lib/privacy/routes.js - selective disclosure routes (sd-1). ADDITIVE.
// GET /api/disclosure?tx=0x..&reveal=kind,settled  - build a disclosure from a REAL receipt
// POST /api/disclosure-verify  (body = the response above) - verify someone else's disclosure
