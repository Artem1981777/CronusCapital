...
export async function runCouncil(args) {
  ...
  if (plan.mode === "unavailable") {
    return Object.freeze({
      ...
      reason: "no_llm_keys", providers: [], consensus: "ABSTAIN",
  ...
  return Object.freeze({
    ...
    mode: plan.mode,
    providers: Array.from(new Set(plan.assignments.map((x) => x.provider))),
...
export default {
  runCouncil, tally, eloUpdate, parseVote, assignProviders,
