...
export const ENDPOINTS = [
  { path: "/api/council", kind: "council", aliases: ["council-consensus"],
    ...
    returns: ["consensus", "confidence", "validVotes", "counts", "dissent", "votes[].model", "providers", "providersAttempted", "providersFailed", "errors"],
    refusals: ["no_llm_keys", "market_unavailable"],
    honesty: "providers перечисляет только зачтённые голоса; опрошенные и упавшие провайдеры лежат в providersAttempted/providersFailed." },
