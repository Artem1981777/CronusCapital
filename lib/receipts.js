...
export default async function handler(req, res) {
  ...
  try {
    ...
    res.status(200).json({ ok: true, network: "arc-mainnet", asset: "USDC", payTo: PAY_TO, count: receipts.length, totalUsdc: totalUsdc, receipts: receipts, updatedAt: new Date().toISOString() })
  } catch (e) {
    res.setHeader("content-type", "application/json")
